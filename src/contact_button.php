...
<body>
    <!-- Nút liên hệ nổi -->
    <section class="contact-button-page">
        <div class="contact-box-bottom animate__animated animate__backInRight">
            <a href="https://www.messenger.com/t/100069933043386" target="_blank">
                <div class="contact-box-wrapper nut-chat-facebook">
                    ...
                    <div class="contact-info">
                        <a href="https://www.messenger.com/t/100069933043386" target="_blank">Chat Facebook</a><br>
                        <span class="time-onl">(8h-22h)</span>
                    </div>
                </div>
            </a>
            <a href="https://zalo.me/0367659288" target="_blank">
                <div class="contact-box-wrapper nut-chat-zalo">
                    ...
                    <div class="contact-info">
                        <a href="https://zalo.me/0367659288" target="_blank">Chat Zalo</a><br>
                        <span class="time-onl">(8h-22h)</span>
                    </div>
                </div>
            </a>
            <a href="tel:+0367659288">
                <div class="contact-box-wrapper nut-chat-phone">
                    ...
                    <div class="contact-info">
                        <a href="tel:+0367659288">0364.313.062</a><br>
                        <span class="time-onl">(8h-22h)</span>
                    </div>
                </div>
            </a>
